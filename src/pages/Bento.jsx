...
const Bento = () => {
  return (
    <div
      id="about"
      className="w-full min-h-screen  flex items-center justify-center px-[1.55rem] py-[1.5rem] md:p-[3rem] bg-black bg-[url('./photos/rrreflection.svg')] "
    >
      <div className="h-full w-full rounded-3xl md:max-h-96 bg-[#171616] shadow-2xl flex flex-col md:flex-row p-5 md:pt-5 md:px-8 gap-[0.5rem] md:gap-[5rem]">
        <div className="text-[2.5rem] md:text-[5rem] font-semibold text-red-500 ">
          About
        </div>
        <div>
          <div className="text-white text-[0.9rem] md:text-[1.3rem] font-light pt-2.5 md:pt-10 font-['poppins'] md:text-justify">
            Aman Kumar Pandey is a passionate software engineer with a focus on
            full-stack development. He excels at building efficient, scalable
            web solutions and is experienced in working across a wide array of
            modern technologies and frameworks. Currently pursuing a degree in
            Computer Science, Aman is driven by solving complex problems and
            delivering seamless user experiences.
          </div>
          <div className="flex gap-2 my-4 justify-start md:justify-center">
            <div>
              <LeetcodeIcon />
            </div>
            <div>
